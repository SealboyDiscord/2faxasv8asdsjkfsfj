...
_G.ThemeInfo = {
    ...
    accentcolor = Color3.fromRGB(215, 113, 255),
    accentcolor2 = Color3.fromRGB(250, 113, 255),
...
if not _G.AccentColors then
    _G.AccentColors = {
        Accent1 = Color3.fromRGB(255, 167, 51),
        Accent2 = Color3.fromRGB(255, 133, 51)           
    } 
end

if not _G.CriminalityInfo then
    _G.CriminalityInfo = {
        SilentAimColor = Color3.fromRGB(55, 102, 255),
        ESPColor = Color3.fromRGB(55, 102, 255)                    
    } 
end

_G.ThemeInfo.accentcolor = _G.AccentColors.Accent1
_G.ThemeInfo.accentcolor2 = _G.AccentColors.Accent2
...
if _G.ThemeInfo.cursor and Drawing then
    local success = pcall(function() 
        library.cursor = Drawing.new("Image")
        library.cursor.Data = game:HttpGet(_G.ThemeInfo.cursorimg)
...
function library:CreateWatermark(name, position)
    ...
    watermark.Outline.BackgroundColor3 = _G.ThemeInfo.outlinecolor
    ...
    watermark.BlackOutline.BackgroundColor3 = _G.ThemeInfo.outlinecolor2
    ...
    watermark.label.Font = _G.ThemeInfo.font
    ...
    watermark.topbar.BackgroundColor3 = _G.ThemeInfo.accentcolor
...
function library:CreateWindow(name, size, hidebutton)
    ...
    window.theme = _G.ThemeInfo

    local updateevent = Instance.new("BindableEvent")
    function window:UpdateTheme(theme)
        updateevent:Fire(theme or _G.ThemeInfo)
        window.theme = (theme or _G.ThemeInfo)
    end
